...
/**
 * Helper methods related to requesting and receiving Newss details  from Google Newss API.
 */
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            //extract response object from the API Object
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // for that news, as results is also a JSON object.
                ...
                // Create a new {@link News} object with the date, title, sectionName,
                // and url from the JSON response.
                News newsObject = new News(newsTitle, sectionName, url);

                // Add the new {@link News} to the list of news.
                newss.add(newsObject);
            }
